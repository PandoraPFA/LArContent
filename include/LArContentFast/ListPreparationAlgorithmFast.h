/**
 *  @file   LArContent/include/LArContentFast/ListPreparationAlgorithmFast.h
 * 
 *  @brief  Header file for the list preparation algorithm class.
 * 
 *  $Log: $
 */
#ifndef LAR_LIST_PREPARATION_ALGORITHM_FAST_H
#define LAR_LIST_PREPARATION_ALGORITHM_FAST_H 1
