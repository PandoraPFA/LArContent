 ...
 */
class SplitShowerMergingAlgorithm : public pandora::Algorithm
{
public:
    /**
...
inline const pandora::Cluster *SplitShowerMergingAlgorithm::ClusterAssociation::GetVertexCluster() const
{
...
inline const pandora::Cluster *SplitShowerMergingAlgorithm::ClusterAssociation::GetDaughterCluster() const
{
...
inline float SplitShowerMergingAlgorithm::ClusterAssociation::GetBoundedFraction() const
{
...
inline bool SplitShowerMergingAlgorithm::ClusterAssociation::IsConsistentDirection() const
{
...
inline const pandora::Pfo *SplitShowerMergingAlgorithm::PfoAssociation::GetVertexPfo() const
{
    return m_pVertexPfo;
}
...
inline const pandora::Pfo *SplitShowerMergingAlgorithm::PfoAssociation::GetDaughterPfo() const
{
...
inline const SplitShowerMergingAlgorithm::ClusterAssociation &SplitShowerMergingAlgorithm::PfoAssociation::GetClusterAssociationU() const
{
...
inline const SplitShowerMergingAlgorithm::ClusterAssociation &SplitShowerMergingAlgorithm::PfoAssociation::GetClusterAssociationV() const
{
...
inline const SplitShowerMergingAlgorithm::ClusterAssociation &SplitShowerMergingAlgorithm::PfoAssociation::GetClusterAssociationW() const
{
