/**
 *  @file   LArContent/include/LArStitching/MultiPandoraApiImpl.h
 * 
...
private:
    ...
    typedef std::map<int, const pandora::Pandora *> VolumeIdMap;
    typedef std::unordered_map<const pandora::Pandora *, VolumeIdMap> PrimaryToVolumeIdMap;
