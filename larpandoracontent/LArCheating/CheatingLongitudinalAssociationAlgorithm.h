/**
 *  @file   larpandoracontent/LArCheating/CheatingLongitudinalAssociationAlgorithm.h
 *
 *  @brief  Header file for the longitudinal association algorithm class.
 *
 *  $Log: $
 */
#ifndef LAR_CHEATING_LONGITUDINAL_ASSOCIATION_ALGORITHM_H
#define LAR_CHEATING_LONGITUDINAL_ASSOCIATION_ALGORITHM_H 1
...
/**
 *  @brief  CheatingLongitudinalAssociationAlgorithm class
 */
class CheatingLongitudinalAssociationAlgorithm : public ClusterAssociationAlgorithm
{
public:
    /**
     *  @brief  Default constructor
     */
    CheatingLongitudinalAssociationAlgorithm();

private:
    pandora::StatusCode ReadSettings(const pandora::TiXmlHandle xmlHandle);
    pandora::StatusCode GetPrincipalAxisVector() const;
...
#endif // #ifndef LAR_CHEATING_LONGITUDINAL_ASSOCIATION_ALGORITHM_H
