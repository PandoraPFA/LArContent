...
HierarchyValidationAlgorithm::~HierarchyValidationAlgorithm()
{
    if (m_writeEventTree)
    {
        ...
        {
            std::cout << "HierarchyValidationAlgorithm: Unable to write to ROOT event tree" << std::endl;
        }
    ...
    if (m_writeMCTree)
    {
        ...
        {
            std::cout << "HierarchyValidationAlgorithm: Unable to write to ROOT MC tree" << std::endl;
        }
    }
}
