/**
 *  @file   LArContent/LArThreeDReco/LArHitCreation/MultiValuedLongitudinalTrackHitsTool.h
 *
...
#include "larpandoracontent/LArContent/LArThreeDReco/LArHitCreation/LongitudinalTrackHitsBaseTool.h"
