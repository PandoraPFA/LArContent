  ...
  private:
    ...
    private:
      ...
      /**
         ...
         */
      void GetSpacePoints(const pandora::ParticleFlowObject* const pPfo,
      ...
      pandora::CartesianVector GetDirection(
        ...
        std::function<bool(const pandora::CartesianVector& pointA,
                           const pandora::CartesianVector& pointB)> fShouldChooseA) const;
      ...
      /**
         ...
         */
      pandora::CartesianVector GetDirectionFromVertex(
        const pandora::CartesianPointVector& spacePoints,
        const pandora::CartesianVector& vertex) const;
      ...
      /**
         ...
         */
      pandora::CartesianVector GetUpperDirection(
        const pandora::CartesianPointVector& spacePoints) const;
      ...
      /**
         ...
         */
      pandora::CartesianVector GetLowerDirection(
        const pandora::CartesianPointVector& spacePoints) const;
      ...
      /**
         ...
         */
      void GetPointsInSphere(const pandora::CartesianPointVector& spacePoints,
     ...
     */
    void GetSliceFeatures(const NeutrinoIdTool* const pTool,
                          const SliceHypotheses& nuSliceHypotheses,
                          const SliceHypotheses& crSliceHypotheses,
     ...
     */
    bool GetBestMCSliceIndex(const pandora::Algorithm* const pAlgorithm,
                             const SliceHypotheses& nuSliceHypotheses,
                             const SliceHypotheses& crSliceHypotheses,
     ...
     */
    bool PassesQualityCuts(const pandora::Algorithm* const pAlgorithm,
                           const float purity,
     ...
     *  @param  selectedPfos the list of pfos to populate
     */
    void SelectPfosByProbability(const pandora::Algorithm* const pAlgorithm,
                                 const SliceHypotheses& nuSliceHypotheses,
                                 const SliceHypotheses& crSliceHypotheses,
