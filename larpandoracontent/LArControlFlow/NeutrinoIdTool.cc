...
namespace lar_content {
  ...
  template <typename T>
  void
  NeutrinoIdTool<T>::SelectOutputPfos(const Algorithm* const pAlgorithm,
  ...
  template <typename T>
  void
  NeutrinoIdTool<T>::GetSliceFeatures(const NeutrinoIdTool<T>* const pTool,
                                      const SliceHypotheses& nuSliceHypotheses,
                                      const SliceHypotheses& crSliceHypotheses,
  ...
  template <typename T>
  bool
  NeutrinoIdTool<T>::GetBestMCSliceIndex(const Algorithm* const pAlgorithm,
                                         const SliceHypotheses& nuSliceHypotheses,
                                         const SliceHypotheses& crSliceHypotheses,
  ...
  template <typename T>
  bool
  NeutrinoIdTool<T>::PassesQualityCuts(const Algorithm* const pAlgorithm,
                                       const float purity,
  ...
  template <typename T>
  void
  NeutrinoIdTool<T>::Collect2DHits(const PfoList& pfos,
                                   CaloHitList& reconstructedCaloHitList,
  ...
  template <typename T>
  unsigned int
  NeutrinoIdTool<T>::CountNeutrinoInducedHits(const CaloHitList& caloHitList) const
  {
  ...
  template <typename T>
  int
  NeutrinoIdTool<T>::GetNuanceCode(const Algorithm* const pAlgorithm) const
  {
    const MCParticleList* pMCParticleList = nullptr;
    PANDORA_THROW_RESULT_IF(
      STATUS_CODE_SUCCESS, !=, PandoraContentApi::GetCurrentList(*pAlgorithm, pMCParticleList));
  ...
  template <typename T>
  void
  NeutrinoIdTool<T>::SelectAllPfos(const pandora::Algorithm* const pAlgorithm,
  ...
  template <typename T>
  void
  NeutrinoIdTool<T>::SelectPfosByProbability(const pandora::Algorithm* const pAlgorithm,
                                             const SliceHypotheses& nuSliceHypotheses,
                                             const SliceHypotheses& crSliceHypotheses,
  ...
  template <typename T>
  void
  NeutrinoIdTool<T>::SelectPfos(const PfoList& pfos, PfoList& selectedPfos) const
  {
  ...
  template <typename T>
  bool
  NeutrinoIdTool<T>::SliceFeatures::IsFeatureVectorAvailable() const
  {
  ...
  template <typename T>
  void
  NeutrinoIdTool<T>::SliceFeatures::GetFeatureVector(
  ...
  template <typename T>
  void
  NeutrinoIdTool<T>::SliceFeatures::GetFeatureMap(LArMvaHelper::DoubleMap& featureMap) const
  {
    if (!m_isAvailable) throw StatusCodeException(STATUS_CODE_NOT_FOUND);
  ...
  template <typename T>
  float
  NeutrinoIdTool<T>::SliceFeatures::GetNeutrinoProbability(const T& t) const
  {
  ...
  NeutrinoIdTool<T>::SliceFeatures::GetNeutrino(const PfoList& nuPfos) const
  {
  ...
  template <typename T>
  void
  NeutrinoIdTool<T>::SliceFeatures::GetSpacePoints(const ParticleFlowObject* const pPfo,
  ...
  template <typename T>
  CartesianVector
  NeutrinoIdTool<T>::SliceFeatures::GetDirectionFromVertex(const CartesianPointVector& spacePoints,
  ...
  template <typename T>
  CartesianVector
  NeutrinoIdTool<T>::SliceFeatures::GetUpperDirection(const CartesianPointVector& spacePoints) const
  {
  ...
  template <typename T>
  CartesianVector
  NeutrinoIdTool<T>::SliceFeatures::GetLowerDirection(const CartesianPointVector& spacePoints) const
  {
    return this->GetDirection(spacePoints,
                              [&](const CartesianVector& pointA, const CartesianVector& pointB) {
                                return (pointA.GetY() < pointB.GetY());
  ...
  template <typename T>
  CartesianVector
  NeutrinoIdTool<T>::SliceFeatures::GetDirection(
  ...
  template <typename T>
  void
  NeutrinoIdTool<T>::SliceFeatures::GetPointsInSphere(
    const CartesianPointVector& spacePoints,
  ...
  template <typename T>
  StatusCode
  NeutrinoIdTool<T>::ReadSettings(const TiXmlHandle xmlHandle)
  {
