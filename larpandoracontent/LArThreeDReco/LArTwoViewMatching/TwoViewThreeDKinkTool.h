/**
 *  @file
 * larpandoracontent/LArThreeDReco/LArTwoViewMatching/TwoViewThreeDKinkTool.h
 *
...
private:
   ...
   */
    ...
    float m_maxTransverseImpactParameter;   ///< The maximum transverse impact
                                            ///< parameter for connecting broken
                                            ///< clusters
    float m_minImpactParameterCosTheta;     ///< The minimum cos theta (angle between
                                            ///< vertex directions) for connecting
                                            ///< broken clusters
