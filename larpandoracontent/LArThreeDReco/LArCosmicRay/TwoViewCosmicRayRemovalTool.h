...
private:
     ...
     */
    void ExamineConnectedElements(TwoViewDeltaRayMatchingAlgorithm *const pAlgorithm, const MatrixType::ElementList &elementList, bool &changesMade) const;
     ...
     */
    bool IsMuonEndpoint(TwoViewDeltaRayMatchingAlgorithm *const pAlgorithm, const MatrixType::Element &element, const pandora::HitType &hitType) const;
     ...
     */
    bool IsBestElement(TwoViewDeltaRayMatchingAlgorithm *const pAlgorithm, const MatrixType::Element &element, const pandora::HitType &hitType, 
     ...
     *  @param  deltaRayRemantHits the list of remainder hits 
     */       
    void SplitDeltaRayCluster(TwoViewDeltaRayMatchingAlgorithm *const pAlgorithm, const MatrixType::Element &element, const pandora::HitType &hitType,
