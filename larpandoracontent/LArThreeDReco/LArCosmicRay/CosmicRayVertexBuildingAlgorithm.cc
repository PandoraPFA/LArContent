...
CartesianVector CosmicRayVertexBuildingAlgorithm::ProjectPosition(
    const CartesianVector &lineStart, const CartesianVector &lineEnd, const CartesianVector &position) const
{
