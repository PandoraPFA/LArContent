...
void ShowerStartRefinementBaseTool::FillAngularDecompositionMap(const CaloHitList &viewShowerHitList, const CartesianVector &projectedNuVertexPosition, 
...
void ShowerStartRefinementBaseTool::ObtainPeakVector(AngularDecompositionMap &angularDecompositionMap, IntVector &viewPeakVector)
{
...
void ShowerStartRefinementBaseTool::ObtainLongitudinalDecomposition(ShowerStartRefinementAlgorithm *const pAlgorithm, const CaloHitList &showerSpineHitList, 
...
void ShowerStartRefinementBaseTool::GetEnergyDistribution(ShowerStartRefinementAlgorithm *const pAlgorithm, const CaloHitList &showerSpineHitList, 
...
void ShowerStartRefinementBaseTool::CharacteriseInitialEnergy(const EnergySpectrumMap &energySpectrumMap, const bool isEndDownstream, float &meanEnergy, float &energySigma)
{
    auto energySpectrumIter(isEndDownstream ? energySpectrumMap.begin() : std::prev(energySpectrumMap.end()));
...
bool ShowerStartRefinementBaseTool::IsShowerTopology(ShowerStartRefinementAlgorithm *const pAlgorithm, const float longitudinalDistance, 
...
void ShowerStartRefinementBaseTool::ConvertLongitudinalProjectionToGlobalPosition(ShowerStartRefinementAlgorithm *const pAlgorithm, 
...
StatusCode ShowerStartRefinementBaseTool::CharacteriseShower(ShowerStartRefinementAlgorithm *const pAlgorithm, const CaloHitList &showerPfoHits, 
...
StatusCode ShowerStartRefinementBaseTool::FillHaloHitPositionVector(const CaloHitList &viewShowerHitList, const CaloHitList &showerSpineHitList, const CartesianVector &showerStartPosition, 
