 ...
 */
  ...
  inline MvaTypes::InitializedDouble&
  MvaTypes::InitializedDouble::operator=(const double number)
  {
    m_number = number;
  ...
  inline MvaTypes::InitializedDouble&
  MvaTypes::InitializedDouble::operator=(const InitializedDouble rhs)
  {
    if (this != &rhs) {
  ...
  inline double
  MvaTypes::InitializedDouble::Get() const
  {
  ...
  inline bool
  MvaTypes::InitializedDouble::IsInitialized() const
  {
