...
namespace lar_content {
  ...
  template <typename T>
  bool
  MvaPfoCharacterisationAlgorithm<T>::IsClearTrack(const Cluster* const pCluster) const
  {
  ...
  template <typename T>
  bool
  MvaPfoCharacterisationAlgorithm<T>::IsClearTrack(
  ...
  template <typename T>
  StatusCode
  MvaPfoCharacterisationAlgorithm<T>::ReadSettings(const TiXmlHandle xmlHandle)
  {
  ...
  template <typename T>
  bool
  MvaPfoCharacterisationAlgorithm<T>::PassesFiducialCut(const CartesianVector& vertex) const
  {
