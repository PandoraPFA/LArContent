...
namespace lar_content {
  ...
  void
  TwoDShowerFitFeatureTool::Run(LArMvaHelper::MvaFeatureVector& featureVector,
  ...
  void
  TwoDShowerFitFeatureTool::Run(LArMvaHelper::MvaFeatureMap& featureMap,
  ...
  StatusCode
  TwoDShowerFitFeatureTool::ReadSettings(const TiXmlHandle xmlHandle)
  {
  ...
  void
  TwoDLinearFitFeatureTool::Run(LArMvaHelper::MvaFeatureVector& featureVector,
                                const Algorithm* const pAlgorithm,
                                const pandora::Cluster* const pCluster)
  {
    if (PandoraContentApi::GetSettings(*pAlgorithm)->ShouldDisplayAlgorithmInfo())
  ...
  void
  TwoDLinearFitFeatureTool::Run(LArMvaHelper::MvaFeatureMap& featureMap,
                                StringVector& featureOrder,
                                const std::string& featureToolName,
                                const Algorithm* const pAlgorithm,
                                const pandora::Cluster* const pCluster)
  ...
  void
  TwoDLinearFitFeatureTool::CalculateVariablesSlidingLinearFit(
    const pandora::Cluster* const pCluster,
  ...
  StatusCode
  TwoDLinearFitFeatureTool::ReadSettings(const TiXmlHandle xmlHandle)
  {
    PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS,
      STATUS_CODE_NOT_FOUND,
  ...
  void
  TwoDVertexDistanceFeatureTool::Run(LArMvaHelper::MvaFeatureVector& featureVector,
                                     const Algorithm* const pAlgorithm,
                                     const pandora::Cluster* const pCluster)
  {
    if (PandoraContentApi::GetSettings(*pAlgorithm)->ShouldDisplayAlgorithmInfo())
  ...
  void
  TwoDVertexDistanceFeatureTool::Run(LArMvaHelper::MvaFeatureMap& featureMap,
                                     StringVector& featureOrder,
                                     const std::string& featureToolName,
                                     const Algorithm* const pAlgorithm,
                                     const pandora::Cluster* const pCluster)
  ...
  StatusCode
  TwoDVertexDistanceFeatureTool::ReadSettings(const TiXmlHandle xmlHandle)
  {
    PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS,
      STATUS_CODE_NOT_FOUND,
  ...
  void
  PfoHierarchyFeatureTool::Run(LArMvaHelper::MvaFeatureVector& featureVector,
                               const Algorithm* const pAlgorithm,
  ...
  void
  PfoHierarchyFeatureTool::Run(LArMvaHelper::MvaFeatureMap& featureMap,
                               StringVector& featureOrder,
                               const std::string& featureToolName,
  ...
  StatusCode
  PfoHierarchyFeatureTool::ReadSettings(const TiXmlHandle /*xmlHandle*/)
  {
    return STATUS_CODE_SUCCESS;
  }
  ...
  void
  ConeChargeFeatureTool::Run(LArMvaHelper::MvaFeatureVector& featureVector,
                             const Algorithm* const pAlgorithm,
                             const pandora::ParticleFlowObject* const pInputPfo)
  {
    if (PandoraContentApi::GetSettings(*pAlgorithm)->ShouldDisplayAlgorithmInfo())
  ...
  void
  ConeChargeFeatureTool::Run(LArMvaHelper::MvaFeatureMap& featureMap,
                             StringVector& featureOrder,
                             const std::string& featureToolName,
                             const pandora::Algorithm* const pAlgorithm,
                             const pandora::ParticleFlowObject* const pInputPfo)
  ...
  void
  ConeChargeFeatureTool::CalculateChargeDistribution(const CaloHitList& caloHitList,
  ...
  float
  ConeChargeFeatureTool::CalculateConicalness(const CaloHitList& caloHitList,
                                              const CartesianVector& pfoStart,
                                              const CartesianVector& pfoDir,
  ...
  StatusCode
  ConeChargeFeatureTool::ReadSettings(const TiXmlHandle xmlHandle)
  {
    PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS,
                                    STATUS_CODE_NOT_FOUND,
                                    !=,
  ...
  void
  ThreeDLinearFitFeatureTool::Run(LArMvaHelper::MvaFeatureVector& featureVector,
                                  const Algorithm* const pAlgorithm,
                                  const pandora::ParticleFlowObject* const pInputPfo)
  {
    if (PandoraContentApi::GetSettings(*pAlgorithm)->ShouldDisplayAlgorithmInfo())
  ...
  void
  ThreeDLinearFitFeatureTool::Run(LArMvaHelper::MvaFeatureMap& featureMap,
                                  StringVector& featureOrder,
                                  const std::string& featureToolName,
                                  const pandora::Algorithm* const pAlgorithm,
                                  const pandora::ParticleFlowObject* const pInputPfo)
  ...
  void
  ThreeDLinearFitFeatureTool::CalculateVariablesSlidingLinearFit(
    const pandora::Cluster* const pCluster,
    float& straightLineLengthLarge,
    float& diffWithStraightLineMean,
    float& maxFitGapLength,
  ...
  StatusCode
  ThreeDLinearFitFeatureTool::ReadSettings(const TiXmlHandle xmlHandle)
  {
    PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS,
      STATUS_CODE_NOT_FOUND,
  ...
  void
  ThreeDVertexDistanceFeatureTool::Run(LArMvaHelper::MvaFeatureVector& featureVector,
                                       const Algorithm* const pAlgorithm,
                                       const pandora::ParticleFlowObject* const pInputPfo)
  {
    if (PandoraContentApi::GetSettings(*pAlgorithm)->ShouldDisplayAlgorithmInfo())
  ...
  void
  ThreeDVertexDistanceFeatureTool::Run(LArMvaHelper::MvaFeatureMap& featureMap,
                                       StringVector& featureOrder,
                                       const std::string& featureToolName,
                                       const pandora::Algorithm* const pAlgorithm,
                                       const pandora::ParticleFlowObject* const pInputPfo)
  ...
  StatusCode
  ThreeDVertexDistanceFeatureTool::ReadSettings(const TiXmlHandle /*xmlHandle*/)
  {
    return STATUS_CODE_SUCCESS;
  }
  ...
  void
  ThreeDOpeningAngleFeatureTool::Run(LArMvaHelper::MvaFeatureVector& featureVector,
                                     const Algorithm* const pAlgorithm,
                                     const pandora::ParticleFlowObject* const pInputPfo)
  {
    if (PandoraContentApi::GetSettings(*pAlgorithm)->ShouldDisplayAlgorithmInfo())
  ...
  void
  ThreeDOpeningAngleFeatureTool::Run(LArMvaHelper::MvaFeatureMap& featureMap,
                                     StringVector& featureOrder,
                                     const std::string& featureToolName,
                                     const pandora::Algorithm* const pAlgorithm,
                                     const pandora::ParticleFlowObject* const pInputPfo)
  ...
  void
  ThreeDOpeningAngleFeatureTool::Divide3DCaloHitList(const Algorithm* const pAlgorithm,
  ...
  float
  ThreeDOpeningAngleFeatureTool::OpeningAngle(const CartesianVector& principal,
  ...
  StatusCode
  ThreeDOpeningAngleFeatureTool::ReadSettings(const TiXmlHandle xmlHandle)
  {
    PANDORA_RETURN_RESULT_IF_AND_IF(STATUS_CODE_SUCCESS,
                                    STATUS_CODE_NOT_FOUND,
                                    !=,
  ...
  void
  ThreeDPCAFeatureTool::Run(LArMvaHelper::MvaFeatureVector& featureVector,
                            const Algorithm* const pAlgorithm,
                            const pandora::ParticleFlowObject* const pInputPfo)
  {
    if (PandoraContentApi::GetSettings(*pAlgorithm)->ShouldDisplayAlgorithmInfo())
  ...
  void
  ThreeDPCAFeatureTool::Run(LArMvaHelper::MvaFeatureMap& featureMap,
                            StringVector& featureOrder,
                            const std::string& featureToolName,
                            const pandora::Algorithm* const pAlgorithm,
                            const pandora::ParticleFlowObject* const pInputPfo)
  ...
  StatusCode
  ThreeDPCAFeatureTool::ReadSettings(const TiXmlHandle /*xmlHandle*/)
  {
    return STATUS_CODE_SUCCESS;
  }
  ...
  void
  ThreeDChargeFeatureTool::Run(LArMvaHelper::MvaFeatureVector& featureVector,
                               const Algorithm* const pAlgorithm,
                               const pandora::ParticleFlowObject* const pInputPfo)
  {
    if (PandoraContentApi::GetSettings(*pAlgorithm)->ShouldDisplayAlgorithmInfo())
  ...
  void
  ThreeDChargeFeatureTool::Run(LArMvaHelper::MvaFeatureMap& featureMap,
                               StringVector& featureOrder,
                               const std::string& featureToolName,
                               const pandora::Algorithm* const pAlgorithm,
                               const pandora::ParticleFlowObject* const pInputPfo)
  ...
  void
  ThreeDChargeFeatureTool::CalculateChargeVariables(const Algorithm* const pAlgorithm,
                                                    const pandora::Cluster* const pCluster,
                                                    float& totalCharge,
                                                    float& chargeSigma,
                                                    float& chargeMean,
  ...
  void
  ThreeDChargeFeatureTool::OrderCaloHitsByDistanceToVertex(const Algorithm* const pAlgorithm,
                                                           const pandora::Cluster* const pCluster,
  ...
  StatusCode
  ThreeDChargeFeatureTool::ReadSettings(const TiXmlHandle xmlHandle)
  {
    PANDORA_RETURN_RESULT_IF_AND_IF(
      STATUS_CODE_SUCCESS,
      STATUS_CODE_NOT_FOUND,
  ...
  bool
  ThreeDChargeFeatureTool::VertexComparator::operator()(const CaloHit* const left,
