/**
 *  @file   larpandoracontent/LArTrackShowerId/MetricBasedShowerGrowingAlgorithm.h
 * 
 *  @brief  Header file for the metric based shower growing algorithm class.
 * 
 *  $Log: $
 */
#ifndef LAR_METRIC_BASED_SHOWER_GROWING_ALGORITHM_H
#define LAR_METRIC_BASED_SHOWER_GROWING_ALGORITHM_H 1
...
/**
 *  @brief  MetricBasedShowerGrowingAlgorithm class
 */
class MetricBasedShowerGrowingAlgorithm : public BranchGrowingAlgorithm
{
public:
    /**
     *  @brief  Default constructor
     */
    MetricBasedShowerGrowingAlgorithm();
...
#endif // #ifndef LAR_METRIC_BASED_SHOWER_GROWING_ALGORITHM_H
