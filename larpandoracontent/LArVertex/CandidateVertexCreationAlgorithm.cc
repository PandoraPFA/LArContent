...
StatusCode CandidateVertexCreationAlgorithm::Run()
{
    ...
    try
    {
        ...
        {
            this->CreateEnergyVertices(clusterListU, clusterListV, clusterListW);
            this->CreateEnergyVertices(clusterListV, clusterListW, clusterListU);
            this->CreateEnergyVertices(clusterListW, clusterListU, clusterListV);
        }
