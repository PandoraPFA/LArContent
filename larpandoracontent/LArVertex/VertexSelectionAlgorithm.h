...
private:
     ...
     *  @param  slidingFitPitch the sliding fit pitch
     * 
     *  @return the list of sliding fit data objects
     */
    SlidingFitDataList CalculateClusterSlidingFits(const pandora::HitType hitType, const float slidingFitPitch) const;
     ...
     */
    float GetEnergyScore(const pandora::Vertex *const pVertex, const BeamConstants &beamConstants, 
     ...
     *  @return the energy score
     */
    void IncrementEnergyScoresForView(const pandora::Vertex *const pVertex, float &energyKick, float &energyAsymmetry, 
                                      const pandora::HitType hitType, const SlidingFitDataList &slidingFitDataList) const;
     ...
     */
    void IncrementEnergyKickParameters(const float distanceToStart, const float distanceToEnd, 
                                      const pandora::CartesianVector &pointToFitStartVector, 
                                      const pandora::CartesianVector &pointToFitEndVector, const pandora::CartesianVector &axisDirection, 
                                      bool &useEnergyMetrics, float &totEnergyKick, float &totEnergy, float &totHitKick, 
                                      unsigned int &totHits, const pandora::Cluster * const pCluster) const;
    ...
    float CalculateEnergyAsymmetry(const pandora::ClusterList &consideredClusters, const pandora::CartesianVector &vertexPosition2D, 
                                   const bool useEnergyMetrics, const pandora::CartesianVector &localEvtAxisDirEnergy, 
                                   const pandora::CartesianVector &localEvtAxisDirHits, bool isViable) const;
    ...
    bool            m_energyScoreOnly;              ///< Whether to use the energy score only, as opposed to the full, fast or midway scores
    ...
    int             m_minNHits;                     ///< The min number of hits parameter in the energy score
...
inline VertexSelectionAlgorithm::SlidingFitData::SlidingFitData(const pandora::Cluster * const pCluster, const int slidingFitWindow, 
...
inline const pandora::CartesianVector & VertexSelectionAlgorithm::SlidingFitData::GetMinLayerDirection() const
{
...
inline const pandora::CartesianVector & VertexSelectionAlgorithm::SlidingFitData::GetMaxLayerDirection() const
{
...
inline const pandora::CartesianVector & VertexSelectionAlgorithm::SlidingFitData::GetMinLayerPosition() const
{
...
inline const pandora::CartesianVector & VertexSelectionAlgorithm::SlidingFitData::GetMaxLayerPosition() const
{
...
inline const pandora::Cluster * VertexSelectionAlgorithm::SlidingFitData::GetCluster() const
{
    return m_pCluster;
}
} // namespace lar_content
