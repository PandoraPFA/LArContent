 ...
 */
  ...
  public:
    ...
    virtual void
    Run(MvaTypes::MvaFeatureMap& featureMap,
 ...
 */
  ...
  template <typename TCONTAINER>
  pandora::StatusCode
  LArMvaHelper::ProduceTrainingExample(const std::string& trainingOutputFile,
                                       const bool result,
                                       TCONTAINER&& featureContainer)
  {
  ...
  template <typename TCONTAINER>
  bool
  LArMvaHelper::Classify(const MvaInterface& classifier, TCONTAINER&& featureContainer)
  {
  ...
  template <typename TCONTAINER>
  bool
  LArMvaHelper::Classify(const MvaInterface& classifier,
                         const pandora::StringVector& featureOrder,
                         TCONTAINER&& featureContainer)
  {
    // Make a feature vector from the map and calculate the features
  ...
  template <typename TCONTAINER>
  double
  LArMvaHelper::CalculateClassificationScore(const MvaInterface& classifier,
                                             TCONTAINER&& featureContainer)
  {
  ...
  template <typename TCONTAINER>
  double
  LArMvaHelper::CalculateProbability(const MvaInterface& classifier, TCONTAINER&& featureContainer)
  {
  ...
  template <typename TCONTAINER>
  double
  LArMvaHelper::CalculateProbability(const MvaInterface& classifier,
                                     const pandora::StringVector& featureOrder,
                                     TCONTAINER&& featureContainer)
  {
    // Make a feature vector from the map and calculate the features
  ...
  LArMvaHelper::CalculateFeatures(const MvaFeatureToolVector<Ts...>& featureToolVector,
                                  TARGS&&... args)
  {
    LArMvaHelper::MvaFeatureVector featureVector;
  ...
  LArMvaHelper::CalculateFeatures(const pandora::StringVector& featureToolOrder,
                                  const MvaFeatureToolMap<Ts...>& featureToolMap,
                                  pandora::StringVector& featureOrder,
                                  TARGS&&... args)
  {
  ...
  template <typename T, typename... Ts, typename... TARGS>
  LArMvaHelper::MvaFeatureVector
  LArMvaHelper::CalculateFeaturesOfType(const MvaFeatureToolVector<Ts...>& featureToolVector,
                                        TARGS&&... args)
  {
  ...
  template <typename... Ts>
  pandora::StatusCode
  LArMvaHelper::AddFeatureToolToVector(pandora::AlgorithmTool* const pFeatureTool,
                                       MvaFeatureToolVector<Ts...>& featureToolVector)
  {
  ...
  template <typename... Ts>
  pandora::StatusCode
  LArMvaHelper::AddFeatureToolToMap(pandora::AlgorithmTool* const pFeatureTool,
                                    std::string pFeatureToolName,
                                    MvaFeatureToolMap<Ts...>& featureToolMap)
  {
    if (MvaFeatureTool<Ts...>* const pCastFeatureTool =
  ...
  inline std::string
  LArMvaHelper::GetTimestampString()
  {
  ...
  LArMvaHelper::WriteFeaturesToFile(std::ofstream& outfile,
                                    const std::string& delimiter,
                                    TCONTAINER&& featureContainer)
  {
    static_assert(
  ...
  template <typename TCONTAINER>
  pandora::StatusCode
  LArMvaHelper::WriteFeaturesToFileImpl(std::ofstream& outfile,
                                        const std::string& delimiter,
                                        TCONTAINER&& featureContainer)
  {
  ...
  template <typename TLIST, typename... TLISTS>
  LArMvaHelper::MvaFeatureVector
  LArMvaHelper::ConcatenateFeatureLists(TLIST&& featureList, TLISTS&&... featureLists)
  {
    static_assert(
  ...
  inline LArMvaHelper::MvaFeatureVector
