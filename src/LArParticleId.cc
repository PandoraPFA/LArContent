...
{
    if (LArParticleId::LArLayerOccupancy(pCluster) < 0.75)
        return false;
...
float LArParticleId::LArLayerOccupancy(const Cluster *const pCluster)
{
...
float LArParticleId::LArLayerOccupancy(const pandora::Cluster *const pCluster1, const pandora::Cluster *const pCluster2)
{
