...
StatusCode KinkSplittingAlgorithm::Run()
{
	...
	//Add daughters of split track to end of list so that we can split them again if necessary
...
//------------------------------------------------------------------------------------------------------------------------------------------
  ...
  StatusCode KinkSplittingAlgorithm::SplitCluster(Cluster *const pCluster, const unsigned int splitLayer, std::list<Cluster*>& daughters) const
{
