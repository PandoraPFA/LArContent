/**
 *  @file   LArContent/src/LArContentFast/CrossedTrackSplittingAlgorithmFast.cc
 *
...
using lar_content::LArPointingClusterHelper;
using lar_content::TwoDSlidingFitResult;
