/**
 *  @file   LArContent/src/LArClusterAssociation/TrackExtensionAlgorithm.cc
 * 
...
void TrackExtensionAlgorithm::GetListOfCleanClusters( const ClusterList *const pClusterList, ClusterVector &clusterVector ) const
{
...
void TrackExtensionAlgorithm::FillAssociationMatrix( const ClusterVector& clusterVector, ClusterAssociationMatrix& clusterAssociationMatrix) const
{
...
void TrackExtensionAlgorithm::FillAssociationMatrix( const LArPointingCluster& clusterI, const LArPointingCluster& clusterJ, ClusterAssociationMatrix& clusterAssociationMatrix ) const
{
    // Sanity Check
...
void TrackExtensionAlgorithm::FillAssociationMatrix( const LArPointingCluster::Vertex &clusterVertexI, const LArPointingCluster::Vertex &clusterVertexJ, ClusterAssociationMatrix& clusterAssociationMatrix ) const
{  
    // Sanity Check
...
bool TrackExtensionAlgorithm::AreClustersAssociated( Cluster* pCluster1, Cluster* pCluster2, ClusterAssociationMatrix& clusterAssociationMatrix ) const
{
...
StatusCode TrackExtensionAlgorithm::ReadSettings(const TiXmlHandle xmlHandle)
{
